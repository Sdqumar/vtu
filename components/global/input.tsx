    ...
    <div className='my-2 relative'>
      ...
      <div>
        ...
        {name === "password" && Type === "password" && <svg
          ...
          className="h-5 w-5 absolute right-3 top-12 cursor-pointer fill-primary" viewBox="0 0 20 20">
        ...
        {name === "password" && Type === "text" && <svg
          ...
          className="h-6 w-6 cursor-pointer absolute right-3 top-12 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
